...
#        starting_nuclei.start() 
    ...
    def creat_directory(self):
        ...
        #print("[location]	/home/Pwn0sec/Desktop/Scanners/PWN0SECscaner/OSTEscaner/Resaults/"+self.name)
        try:
...
#         output = subprocess.run("nikto -h {}  -o /home/Pwn0sec/Desktop/Scanners/PWN0SECscaner/OSTEscaner/Resaults/{}/nikto/{}_f.json -F json -Tuning f".format(url,name,name), shell=True, capture_output=True)
...
#     get_nikto_vulnerability("/home/Pwn0sec/Desktop/Scanners/PWN0SECscaner/OSTEscaner/Resaults/{}/nikto/{}_f".format(name,name))
...
def check_for_zap2(): 
    ...
    while string[3]=="E":	
       ...
       string=str(output1.stdout)    
        ...
        output1= subprocess.run("zap-cli --zap-url http://0.0.0.0:8090/ -p 8090 report -f html -o /home/Pwn0sec/Desktop/Scanners/PWN0SECscaner/OSTEscaner/Resaults/{}/owaspzap/{}.html".format(name,name),shell=True,capture_output=True) 
        output1= subprocess.run("zap-cli --zap-url http://0.0.0.0:8090/ -p 8090 report -f xml -o /home/Pwn0sec/Desktop/Scanners/PWN0SECscaner/OSTEscaner/Resaults/{}/owaspzap/{}.xml".format(name,name),shell=True,capture_output=True) 
        print("_____________________Zap Resault is in:_____________________________ ")
        print("/home/Pwn0sec/Desktop/Scanners/OSTEscaner/Resaults/{}/owaspzap/{}.html".format(name,name))
        print("/home/Pwn0sec/Desktop/Scanners/OSTEscaner/Resaults/{}/owaspzap/{}.xml".format(name,name))
...
# Reading the data inside the xml file to a variable under the name  data
     with open('/home/Pwn0sec/Desktop/Scanners/PWN0SECscaner/OSTEscaner/Resaults/{}/owaspzap/{}.xml'.format(name,name), 'r') as f:
         data = f.read() 
