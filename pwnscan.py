...
class Target_Window(customtkinter.CTkToplevel):
    def __init__(self,*args,**kwargs):
        ...
        self.title("Web Vulnerability PWN0SEC-Scanner  -servers-")
        self.directory="no"
        script_dir = os.path.abspath(os.path.dirname(sys.argv[0]))
...
class loadResult_Window(customtkinter.CTkToplevel):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.title("Web Vulnerability PWN0SEC-Scanner  -Resault-")
...
class set_setting_Window(customtkinter.CTkToplevel):        
    def __init__(self, *args, **kwargs):
        ...
        super().__init__(*args, **kwargs)
        self.title("Web Vulnerability PWN0SEC-Scanner  -Settings-")
        self.geometry("500x500")
        self.setting_tabview = customtkinter.CTkTabview(self)
        self.setting_tabview.pack(pady=20,padx=20,fill ="both",expand=True)
        self.setting_tabview.add("PWN0SEC-Scanner")
        self.setting_tabview.add("OWASP ZAP")
        self.setting_tabview.add("wapiti")
        self.setting_tabview.add("Skipfish")

        #Meta- tab view:
        self.label_1 = customtkinter.CTkLabel(self.setting_tabview.tab("PWN0SEC-Scanner"),text="PWN0SEC-Scanner Settings:", justify=customtkinter.CENTER)
        self.label_1.grid(row=0, column=0 ,columnspan=6,padx=160)
        self.sup1=customtkinter.CTkLabel(self.setting_tabview.tab("PWN0SEC-Scanner"),text="---------------------------------------------------", justify=customtkinter.CENTER).grid(row=1,column=0,columnspan=6,padx=0,pady=0)
        self.msg1 =customtkinter.CTkLabel(self.setting_tabview.tab("PWN0SEC-Scanner"),text="Reset Weights (Initials values)").grid(row=2,column=0,columnspan=3,padx=10,pady=(30,10),sticky='w')
        self.but1 =customtkinter.CTkButton(self.setting_tabview.tab("PWN0SEC-Scanner"),text="Reset",command=self.reset).grid(row=2,column=3,columnspan=3,padx=10,pady=(30,10))
        self.msg1 =customtkinter.CTkLabel(self.setting_tabview.tab("PWN0SEC-Scanner"),text="Load Weights").grid(row=3,column=0,columnspan=3,padx=10,pady=10,sticky='w')
        self.but1 =customtkinter.CTkButton(self.setting_tabview.tab("PWN0SEC-Scanner"),text="Load",command=self.load).grid(row=3,column=3,columnspan=3,padx=10,pady=10)
        self.msg1 =customtkinter.CTkLabel(self.setting_tabview.tab("PWN0SEC-Scanner"),text="NOTE:check weights/initiale_weights.json for file structure",text_color="red").grid(row=5,column=0,columnspan=6,padx=0,pady=0,sticky='w')
        self.msg1 =customtkinter.CTkLabel(self.setting_tabview.tab("PWN0SEC-Scanner"),text="Save current Weights").grid(row=4,column=0,columnspan=3,padx=10,pady=10,sticky='w')
        self.but1 =customtkinter.CTkButton(self.setting_tabview.tab("PWN0SEC-Scanner"),text="Save",command=self.save).grid(row=4,column=3,columnspan=3,padx=10,pady=10)
    ...
    def reset(self):
        ...
        fileObject.close()           
        self.msg1 =customtkinter.CTkLabel(self.setting_tabview.tab("PWN0SEC-Scanner"),text="Weights has been restored successfully",text_color=("green","LightGreen"), justify=customtkinter.CENTER).grid(row=6,column=0,columnspan=6,padx=10,pady=(50,0))
    def save(self):
        ...
        fileObject.write(json.dumps(weights))
        fileObject.close()           
        self.msg1 =customtkinter.CTkLabel(self.setting_tabview.tab("PWN0SEC-Scanner"),text="Weights has been Saved successfully in:",text_color=("green","LightGreen"), justify=customtkinter.CENTER).grid(row=6,column=0,columnspan=6,padx=10,pady=(50,0))
        self.ddd =customtkinter.CTkLabel(self.setting_tabview.tab("PWN0SEC-Scanner"),text="{}/weight.json".format(directory_path),text_color=("green","LightGreen"), justify=customtkinter.CENTER).grid(row=7,column=0,columnspan=6,padx=10,pady=5)
        self.lift()
    ...
    def load(self):
        ...
        fileObject.write(json.dumps(weights))
        fileObject.close()           
        self.msg1 =customtkinter.CTkLabel(self.setting_tabview.tab("PWN0SEC-Scanner"),text="Weights has been Load successfully",text_color=("green","LightGreen"), justify=customtkinter.CENTER).grid(row=6,column=0,columnspan=6,padx=10,pady=(50,0))
        self.lift()
...
class start_Window(customtkinter.CTkToplevel):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.title("Web Vulnerability PWN0SEC-Scanner  -Starting Scan-")
...
#        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join("images/pwn.ico")), size=(20, 20)) 
#        self.iconbitmap(default="images/pwn.ico")        #configure the menu:
...
#        self.menubar.add_command(label="About",command=print("about not yet finished"),underline=0)
    ...
    def maximize(self):
        ...
        self.logo_label = customtkinter.CTkLabel(self.sidebar_frame, text="PWN0SEC-Scanner", font=customtkinter.CTkFont(size=20, weight="bold"))
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join("images/pwn.png")), size=(190, 150))   
...
#           14
    ...
    def chec_for_scanner(self):
            new_checker= PWN0SECscaner.scan_checker()
...
class MyFrame_My_Result(customtkinter.CTkScrollableFrame):
    def __init__(self, master, **kwargs):
        ...
        self.label.grid(row=0, column=0,padx=3,pady=3)
        self.label1 = customtkinter.CTkLabel(self,text="pwn-scan",width=50,anchor="w",text_color=("green","LightGreen"))
...
if __name__ == "__main__":
    app = App()
#    app.iconbitmap("images/pwn.ico")        #configure the menu:
